...
class Main {
 ...
 public static void main(String[] args)throws IOException{
  ...
  void init() {
    ...
    sql = "Insert Into section3  period1 ";
    sql += " (teacher1, room, student2, section, period)";
    sql += "Values ('WHOKNOWS', 'ROOFTOP' , 'STUDENT2', 'SECTION3 , PERIOD1')";
  
    db.runSQL(sql);
    
    // 2: For student with ID “STUDENT4”, add course “CN100” with a section 1, teacher1 as  “JOSEPH”, period 2 and room 108.
    sql = "Insert studentid, course, teacher, period2, room108";
    sql += " (student, CN100, JOSEPH, period2, 108)";
    sql += "Values ('STUDENT4', 'CN100', 'JOSEPH',)";
